...
/**
 *  Operations for service "payrollDB"
 *  08/27/2013 15:21:54
 * 
 */
    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.payrolldb.data.Payrollstatusdef getPayrollstatusdefById(Integer id, PagingOptions pagingOptions) {
        List<com.payrolldb.data.Payrollstatusdef> rtn = ((List<com.payrolldb.data.Payrollstatusdef> ) dsMgr.invoke(taskMgr.getQueryTask(), (PayrollDBConstants.getPayrollstatusdefByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
